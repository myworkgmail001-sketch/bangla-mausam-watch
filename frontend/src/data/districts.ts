...
export const districts: District[] = [
  { slug: 'alkol', name: 'Alipurduar', namebn: 'আলিপুরদুয়ার', lat: 26.49, lng: 89.53, population: 1590000, area: 3383, headquarters: 'Alipurduar', headquartersbn: 'আলিপুরদুয়ার', rivers: ['Teesta', 'Jamuna'], coordinates: [[89.30, 26.60], [89.80, 26.60], [89.80, 26.40], [89.30, 26.40]] },
  ...
  { slug: 'birgunj', name: 'Burdwan', namebn: 'বর্ধমান', lat: 23.24, lng: 87.86, population: 7100000, area: 7024, headquarters: 'Bardhaman', headquartersbn: 'বর্ধমান', rivers: ['Damodar', 'Bhagirathi'], coordinates: [[87.50, 23.50], [88.20, 23.50], [88.20, 23.00], [87.50, 23.00]] },
  ...
  { slug: 'jagatballavpur', name: 'Jalpaiguri', namebn: 'জলপাইগুড়ি', lat: 26.55, lng: 88.72, population: 3910000, area: 6227, headquarters: 'Jalpaiguri', headquartersbn: 'জলপাইগুড়ি', rivers: ['Teesta', 'Jaldhaka'], coordinates: [[88.40, 26.80], [89.00, 26.80], [89.00, 26.30], [88.40, 26.30]] },
  ...
  { slug: 'murshidabad', name: 'Murshidabad', namebn: 'মুর্শিদাবাদ', lat: 24.18, lng: 88.27, population: 7140000, area: 5324, headquarters: 'Barrackpore', headquartersbn: 'ব্যারাকপুর', rivers: ['Bhagirathi', 'Mahananda'], coordinates: [[88.00, 24.40], [88.60, 24.40], [88.60, 23.90], [88.00, 23.90]] },
  ...
  { slug: 'siliguri', name: 'Siliguri (Greater)', namebn: 'শিলিগুড়ি (বৃহত্তর)', lat: 26.72, lng: 88.43, population: 3100000, area: 2649, headquarters: 'Siliguri', headquartersbn: 'শিলিগুড়ি', rivers: ['Teesta', 'Mahalananda'], coordinates: [[88.20, 26.90], [88.70, 26.90], [88.70, 26.50], [88.20, 26.50]] },
