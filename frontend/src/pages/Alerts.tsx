...
const MOCK_ALERTS: AlertItem[] = [
  {
    id: '1',
    title: 'বন্যা সতর্কতা: ব্রাহ্মণবাড়িয়া জেলা',
    titleEn: 'Flood Warning: Brahmanbaria District',
    message: 'মেঘনা নদীর জলের প্রবণতা বৃদ্ধি পাচ্ছে। নিম্নাঞ্চলের বাসিন্দাদের সতর্ক থাকার অনুরোধ করা হচ্ছে।',
    messageEn: 'Megalaya river levels are rising. Residents of low-lying areas are advised to stay alert.',
  ...
  {
    id: '2',
    title: 'তীব্র ঝড় সতর্কতা: কক্সবাজার',
    titleEn: 'Severe Storm Warning: Cox\'s Bazar',
    message: 'আসন্ন ৪৮ ঘণ্টায় কক্সবাজার জেলায় তীব্র ঝড় ও বৃষ্টি হতে পারে।',
    messageEn: 'Heavy storms and rainfall expected in Cox\'s Bazar over the next 48 hours.',
    district: 'coxsbazar',
    severity: 'orange',
  ...
  {
    id: '3',
    title: 'ভূমিকম্প সতর্কতা: সিলেট অঞ্চল',
    titleEn: 'Earthquake Alert: Sylhet Region',
    message: 'সিলেট অঞ্চলে সামান্য ভূমিকম্প অনুভূত হয়েছে। ক্ষতির কোনো সূচনা নেই।',
    messageEn: 'A minor earthquake has been felt in the Sylhet region. No reports of damage.',
    district: 'sylhet',
    severity: 'yellow',
  ...
  {
    id: '4',
    title: 'ভূমিধস সতর্কতা: চট্টগ্রাম পাহাড়ি এলাকা',
    titleEn: 'Landslide Warning: Chittagong Hill Tracts',
    message: 'অবিরাম বৃষ্টির কারণে চট্টগ্রাম পাহাড়ি এলাকায় ভূমিধসের ঝড় বেশি।',
    messageEn: 'Increased risk of landslides in Chittagong Hill Tracts due to continuous rainfall.',
    district: 'chattogram',
    severity: 'orange',
  ...
  {
    id: '5',
    title: 'তাপমাত্রা সতর্কতা: রাজশাহী বিভাগ',
    titleEn: 'Temperature Alert: Rajshahi Division',
    message: 'রাজশাহী বিভাগে তাপমাত্রা ৪০ ডিগ্রি সেলসিয়াসের উপরে উঠতে পারে।',
    messageEn: 'Temperatures in Rajshahi Division may exceed 40°C.',
    district: 'rajshahi',
    severity: 'yellow',
  ...
  {
    id: '6',
    title: 'ধুলোবালি সতর্কতা: খুলনা বিভাগ',
    titleEn: 'Dust & Haze Alert: Khulna Division',
    message: 'খুলনা বিভাগে ধুলোবালি ও ধোঁয়ার ঘনত্ব বেড়েছে। বাইরে যাওয়া এড়িয়ে চলুন।',
    messageEn: 'Dust and haze levels elevated in Khulna Division. Avoid going outdoors.',
    district: 'khulna',
    severity: 'green',
    eventType: 'dustAndHaze',
